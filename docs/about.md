<div class="about-header">
  <img src="assets/pfp(theone).jpg" alt="Portrait of Ryan Wang" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Hi I'm Ryan!</h1>
  ...
  <a href="https://github.com/ryan-twang" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/ryanw08" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:ryanwang0808@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I’m a Information System student at Carnegie Mellon University, with strong interests in software engineering, data, and emerging technologies like quantum computing.
